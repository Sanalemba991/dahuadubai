...
export default function SmartAnalyticsPage() {
  ...
  const mobileBannerData = {
    image: "/mobile/tech/full-color.jpg",
    title: "AI-Powered",
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              >
                <div className="rounded-2xl bg-black overflow-hidden mb-6 shadow-lg">
                  <Image
                    src="/fullcolor/people Analytics.jpg"
              ...
              >
                <div className="rounded-2xl overflow-hidden mb-6 shadow-lg">
                  <Image
                    src="/fullcolor/Vehicle Analytics.jpg"
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            ...
            >
              ...
              <motion.div
                className="grid md:grid-cols-4 gap-8 text-red-600"
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ duration: 0.8, delay: 0.6 }}
              >
                {[
                  { value: '99.5', prefix: '', suffix: '%', label: 'Accuracy Rate' },
                  { value: '100', prefix: '<', suffix: 'ms', label: 'Response Time' },
                  { value: '50', prefix: '', suffix: '+', label: 'AI Algorithms' },
                  { value: '1000', prefix: '', suffix: '+', label: 'Cameras Support' },
                ].map((spec, index) => (
