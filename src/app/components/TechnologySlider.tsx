      ...
      const results = await Promise.all(
        slides.map(async (slide, index) => {
          try {
            ...
            const imageSrc = typeof imageToLoad === 'string' ? imageToLoad : imageToLoad.src;
            img.src = imageSrc;
              ...
              {slides.map((slide, index) => (
                ...
                >
                  {loadedImages[index] === false ? (
                    ...
                    <img
                      src={isMobile ? (typeof slide.mobileImage === 'string' ? slide.mobileImage : slide.mobileImage.src) : (typeof slide.image === 'string' ? slide.image : slide.image.src)}
                      alt={slide.title}
